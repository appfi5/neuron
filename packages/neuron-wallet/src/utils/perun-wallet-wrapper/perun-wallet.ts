...
export interface RestoreChannelsRequest {
  data: Uint8Array;
}

export interface RestoreChannelsResponse {
  accepted: boolean;
  data: Uint8Array;
}

export interface ClosePerunClientRequest {
  data: Uint8Array;
}

export interface ClosePerunClientResponse {
  accepted: boolean;
  data: Uint8Array;
}

export interface NewPerunClientRequest {
  data: Uint8Array;
}

export interface NewPerunClientResponse {
  accepted: boolean;
  data: Uint8Array;
}
...
export interface GetChannelsResponse {
  ...
  channelStates?: ChannelStates | undefined;
}
...
function createBaseRestoreChannelsRequest(): RestoreChannelsRequest {
  return { data: new Uint8Array(0) };
}

export const RestoreChannelsRequest = {
  encode(message: RestoreChannelsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RestoreChannelsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRestoreChannelsRequest();
  ...
  fromJSON(object: any): RestoreChannelsRequest {
    return { data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0) };
  },

  toJSON(message: RestoreChannelsRequest): unknown {
    const obj: any = {};
    if (message.data.length !== 0) {
  ...
  create(base?: DeepPartial<RestoreChannelsRequest>): RestoreChannelsRequest {
    return RestoreChannelsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RestoreChannelsRequest>): RestoreChannelsRequest {
    const message = createBaseRestoreChannelsRequest();
...
function createBaseRestoreChannelsResponse(): RestoreChannelsResponse {
  return { accepted: false, data: new Uint8Array(0) };
}

export const RestoreChannelsResponse = {
  encode(message: RestoreChannelsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RestoreChannelsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRestoreChannelsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RestoreChannelsResponse {
    return {
  ...
  toJSON(message: RestoreChannelsResponse): unknown {
    const obj: any = {};
    if (message.accepted !== false) {
  ...
  create(base?: DeepPartial<RestoreChannelsResponse>): RestoreChannelsResponse {
    return RestoreChannelsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RestoreChannelsResponse>): RestoreChannelsResponse {
    const message = createBaseRestoreChannelsResponse();
...
function createBaseClosePerunClientRequest(): ClosePerunClientRequest {
  return { data: new Uint8Array(0) };
}

export const ClosePerunClientRequest = {
  encode(message: ClosePerunClientRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClosePerunClientRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseClosePerunClientRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ClosePerunClientRequest {
    return { data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0) };
  },

  toJSON(message: ClosePerunClientRequest): unknown {
    const obj: any = {};
    if (message.data.length !== 0) {
      obj.data = base64FromBytes(message.data);
    }
  ...
  create(base?: DeepPartial<ClosePerunClientRequest>): ClosePerunClientRequest {
    return ClosePerunClientRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClosePerunClientRequest>): ClosePerunClientRequest {
    const message = createBaseClosePerunClientRequest();
    message.data = object.data ?? new Uint8Array(0);
    return message;
  },
...
function createBaseClosePerunClientResponse(): ClosePerunClientResponse {
  return { accepted: false, data: new Uint8Array(0) };
}

export const ClosePerunClientResponse = {
  encode(message: ClosePerunClientResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.accepted !== false) {
      writer.uint32(8).bool(message.accepted);
    }
    if (message.data.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ClosePerunClientResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseClosePerunClientResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ClosePerunClientResponse {
    return {
      accepted: isSet(object.accepted) ? globalThis.Boolean(object.accepted) : false,
      data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
    };
  ...
  toJSON(message: ClosePerunClientResponse): unknown {
    const obj: any = {};
    if (message.accepted !== false) {
      obj.accepted = message.accepted;
    }
  ...
  create(base?: DeepPartial<ClosePerunClientResponse>): ClosePerunClientResponse {
    return ClosePerunClientResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClosePerunClientResponse>): ClosePerunClientResponse {
    const message = createBaseClosePerunClientResponse();
    message.accepted = object.accepted ?? false;
    message.data = object.data ?? new Uint8Array(0);
    return message;
...
function createBaseNewPerunClientRequest(): NewPerunClientRequest {
  return { data: new Uint8Array(0) };
}

export const NewPerunClientRequest = {
  encode(message: NewPerunClientRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NewPerunClientRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseNewPerunClientRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): NewPerunClientRequest {
    return { data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0) };
  },

  toJSON(message: NewPerunClientRequest): unknown {
    const obj: any = {};
    if (message.data.length !== 0) {
      obj.data = base64FromBytes(message.data);
    }
  ...
  create(base?: DeepPartial<NewPerunClientRequest>): NewPerunClientRequest {
    return NewPerunClientRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<NewPerunClientRequest>): NewPerunClientRequest {
    const message = createBaseNewPerunClientRequest();
    message.data = object.data ?? new Uint8Array(0);
    return message;
  },
...
function createBaseNewPerunClientResponse(): NewPerunClientResponse {
  return { accepted: false, data: new Uint8Array(0) };
}

export const NewPerunClientResponse = {
  encode(message: NewPerunClientResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.accepted !== false) {
      writer.uint32(8).bool(message.accepted);
    }
    if (message.data.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NewPerunClientResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseNewPerunClientResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): NewPerunClientResponse {
    return {
      accepted: isSet(object.accepted) ? globalThis.Boolean(object.accepted) : false,
      data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
    };
  ...
  toJSON(message: NewPerunClientResponse): unknown {
    const obj: any = {};
    if (message.accepted !== false) {
      obj.accepted = message.accepted;
    }
  ...
  create(base?: DeepPartial<NewPerunClientResponse>): NewPerunClientResponse {
    return NewPerunClientResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<NewPerunClientResponse>): NewPerunClientResponse {
    const message = createBaseNewPerunClientResponse();
    message.accepted = object.accepted ?? false;
    message.data = object.data ?? new Uint8Array(0);
    return message;
...
function createBaseGetChannelsResponse(): GetChannelsResponse {
  return { rejected: undefined, channelStates: undefined };
}
...
export const GetChannelsResponse = {
  encode(message: GetChannelsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.channelStates !== undefined) {
      ChannelStates.encode(message.channelStates, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.channelStates = ChannelStates.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): GetChannelsResponse {
    return {
      ...
      channelStates: isSet(object.channelStates) ? ChannelStates.fromJSON(object.channelStates) : undefined,
    };
  },
  ...
  toJSON(message: GetChannelsResponse): unknown {
    ...
    if (message.channelStates !== undefined) {
      obj.channelStates = ChannelStates.toJSON(message.channelStates);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GetChannelsResponse>): GetChannelsResponse {
    ...
    message.rejected = (object.rejected !== undefined && object.rejected !== null)
      ...
      : undefined;
    message.channelStates = (object.channelStates !== undefined && object.channelStates !== null)
      ? ChannelStates.fromPartial(object.channelStates)
      : undefined;
    return message;
  },
};

function createBaseChannelStates(): ChannelStates {
  return { states: [], actorIdxs: [] };
}

export const ChannelStates = {
  encode(message: ChannelStates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.states) {
      State.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    writer.uint32(18).fork();
    for (const v of message.actorIdxs) {
      writer.uint32(v);
    }
    writer.ldelim();
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChannelStates {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChannelStates();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          if (tag === 16) {
            message.actorIdxs.push(reader.uint32());
  ...
  fromJSON(object: any): ChannelStates {
    return {
      states: globalThis.Array.isArray(object?.states) ? object.states.map((e: any) => State.fromJSON(e)) : [],
      actorIdxs: globalThis.Array.isArray(object?.actorIdxs)
        ? object.actorIdxs.map((e: any) => globalThis.Number(e))
        : [],
    };
  },

  toJSON(message: ChannelStates): unknown {
    const obj: any = {};
    if (message.states?.length) {
      obj.states = message.states.map((e) => State.toJSON(e));
    }
    if (message.actorIdxs?.length) {
      obj.actorIdxs = message.actorIdxs.map((e) => Math.round(e));
    }
    return obj;
  },

  create(base?: DeepPartial<ChannelStates>): ChannelStates {
    return ChannelStates.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ChannelStates>): ChannelStates {
    const message = createBaseChannelStates();
    message.states = object.states?.map((e) => State.fromPartial(e)) || [];
    message.actorIdxs = object.actorIdxs?.map((e) => e) || [];
    return message;
  },
};
...
export const ChannelServiceDefinition = {
  ...
  methods: {
    ...
    restoreChannels: {
      ...
      requestType: RestoreChannelsRequest,
      requestStream: false,
      responseType: RestoreChannelsResponse,
      responseStream: false,
      options: {},
    },
    closePerunClient: {
      name: "ClosePerunClient",
      requestType: ClosePerunClientRequest,
      requestStream: false,
      responseType: ClosePerunClientResponse,
      responseStream: false,
      options: {},
    },
    ...
    newPerunClient: {
      name: "NewPerunClient",
      requestType: NewPerunClientRequest,
      requestStream: false,
      responseType: NewPerunClientResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface ChannelServiceImplementation<CallContextExt = {}> {
  ...
  restoreChannels(
    request: RestoreChannelsRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<RestoreChannelsResponse>>;
  closePerunClient(
    request: ClosePerunClientRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ClosePerunClientResponse>>;
  /** For testing purposes */
  newPerunClient(
    request: NewPerunClientRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<NewPerunClientResponse>>;
}
...
export interface ChannelServiceClient<CallOptionsExt = {}> {
  ...
  restoreChannels(
    request: DeepPartial<RestoreChannelsRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<RestoreChannelsResponse>;
  closePerunClient(
    request: DeepPartial<ClosePerunClientRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ClosePerunClientResponse>;
  /** For testing purposes */
  newPerunClient(
    request: DeepPartial<NewPerunClientRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<NewPerunClientResponse>;
}
