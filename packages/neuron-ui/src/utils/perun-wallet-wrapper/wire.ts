...
function createBaseAllocation(): Allocation {
  return { backends: [], assets: [], balances: undefined, locked: [] };
}
...
export const Allocation = {
  encode(message: Allocation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.balances !== undefined) {
      Balances.encode(message.balances, writer.uint32(26).fork()).ldelim();
    }
    for (const v of message.locked) {
      SubAlloc.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.backends.push(reader.bytes());
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): Allocation {
    return {
      backends: globalThis.Array.isArray(object?.backends) ? object.backends.map((e: any) => bytesFromBase64(e)) : [],
  ...
  toJSON(message: Allocation): unknown {
    ...
    if (message.backends?.length) {
      obj.backends = message.backends.map((e) => base64FromBytes(e));
    }
...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.ledgerChannel !== false) {
